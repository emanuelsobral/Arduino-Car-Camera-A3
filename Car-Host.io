...
const char* ap_ssid = "Carro-A3";
const char* ap_password = "12345678";
IPAddress local_ip(192, 168, 4, 1);        // Endereço IP fixo do AP
IPAddress gateway(192, 168, 4, 1);         // Gateway padrão
...
void setup() {
  ...
  Serial.print("Ponto de Acesso Iniciado. Acesse: http://");
